...
import { VOUCHER_LIST_TABLE } from '../../../../shared/form-builder/table/voucher';
...
export class VoucherListComponent {
	...
	tableConfig: TableModel = VOUCHER_LIST_TABLE;
	searchControl: FormControl = new FormControl('');
	formConfig = {
		search: signal<IViewList>(VIEW_LIST_FORM('Search by campaign name')),
	};
